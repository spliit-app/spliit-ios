...
.DEFAULT_GOAL := help
.PHONY: help setup generate build build-device device test test-live e2e e2e-up e2e-down e2e-seed fixtures run shot sim sim-clean clean lint archive ipa testflight
